...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <!-- <div class="col-md-5 align-self-center">
            <h3 class="text-white">Categories</h3> </div> -->
        <div class="col">
            <ol class="breadcrumb">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th style="color:#959595;">Image</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                try {
                                    ...
                                    foreach ($catArray as $iValue) {
                                        ...
                                        if ($cObj->get('image') !== null) {
                                            ...
                                            $image_url = $cObj->get('image')->getURL(); 
                                                
                                            $image = "<span><a href='#' onclick='showImage(\"$image_url\")' class=\"badge badge-info\" style=\"background:#5d0375;\">View</a></span>";
                                        }else{
