    ...
    <div class="row page-titles">
        ...
        <div class="col">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">All Entrance Effect</li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th style="color:#959595;">Category</th>
                                    <th style="color:#959595;">Credits</th>
                                ...
                                try {
                                    ...
                                    foreach ($catArray as $iValue) {
                                        ...
                                        if ($typeFile !== null){
                                            ...
                                            $file = "<span/><a target='_blank' href=\"$profilePhotoUrl\" class=\"badge badge-info\" style=\"background:#5d0375;\">Download</a></span>";
