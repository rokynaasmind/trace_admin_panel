...
if(isset($_POST['val-name']) && isset($_POST['val-credits']) && isset($_FILES['val-file'])){
    ...
    if($currUser->getObjectId() == "HwvtVkUbZp") {
        ...
        $newGift->set("categories","party_theme");
    ...
    <div class="row page-titles">
        ...
        <div class="col">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add new Party Theme </li>
            </ol>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="val-name" class="col-sm-4 col-form-label">Party Theme Name<span class="text-danger">*</span> </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="val-name" name="val-name" placeholder="Give a name to Party Theme" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="val-credits" name="val-credits" placeholder="Credits needed to buy Party Theme" required>
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="invalid-feedback">Please choose your Party Theme file, in PNG format</div>
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                            </div>
