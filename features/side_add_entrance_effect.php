...
if(isset($_POST['val-name']) && isset($_POST['val-credits']) && isset($_FILES['val-file'])){
    ...
    if($currUser->getObjectId() == "HwvtVkUbZp") {
        ...
        $newGift->set("categories","entrance_effect");
    ...
    <div class="row page-titles">
        ...
        <div class="col">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add new Entrance Effect </li>
            </ol>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="val-name" class="col-sm-4 col-form-label">Entrance Effect Name<span class="text-danger">*</span> </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="val-name" name="val-name" placeholder="Give a name to Entrance Effect" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="val-credits" name="val-credits" placeholder="Credits needed to buy Entrance Effect" required>
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                        </div>

                            <div class="form-group row">
                                <label for="val-file" class="col-sm-4 col-form-label">SVGA file<span class="text-danger">*</span></label>
                                <div class="col-sm-8">
                                    <input id="val-file" name="val-file" type="file" accept=".svga" required />
                                    <div class="invalid-feedback">Please choose your Entrance Effect file, in SVGA format</div>
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                            </div>
