...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Phone clicks</h3> </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Features</a></li>
                <li class="breadcrumb-item active">Phone clicks</li>
            </ol>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg">
                ...
                <div class="card">
                    ...
                    $query = new ParseQuery("CallsClicks");
                    $messagesCounter = 0; try { $messagesCounter = $query->count(); } catch (Exception $e) { $messagesCounter = '?'; }

                    echo ' <h2 class="card-title">'.$messagesCounter.' Phone clicks in total</h2> ';
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                try {
                                    ...
                                    foreach ($catArray as $iValue) {
                                        ...
                                        $fromName = $cObj->get('Caller')->get('name');
                                        $toName = $cObj->get('Receiver')->get('name');

                                        $phone = $cObj->get('PhoneNumber');
                                        $calltype = "<span class=\"badge badge-primary\">$phone</span>";
